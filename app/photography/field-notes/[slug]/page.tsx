...
const postMeta: Record<string, { description: string; cover: string; date: string }> = {
  ...
  'lensball-photography':      { description: 'A practical guide to lensball photography — how to compose a refracted scene, avoid common mistakes, and get sharp shots with a Sony mirrorless camera.', cover: '/images/field-notes/lensball-forest-log-refraction-christopher-brenzel.jpg', date: '2023-12-12' },
